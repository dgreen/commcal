...
public class MDCalendarPrinter implements CalendarPrinter {
   ...
   * @param calendarRoleName text describing the role for this calendar
  ...
  public void print(ArrayList<Activity> activities, String calendarRoleName, int year) {
    ...
    System.out.println("Title: Calendar for " + calendarRoleName + " in " + year);
    System.out.println("CSS: style.css");
    System.out.println();
    System.out.println("# Calendar for " + calendarRoleName + " in " + year);
    System.out.println();
